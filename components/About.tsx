...
export default function About({}: Props) {
  return (
    <>
    <div className=' lg:h-screen flex flex-col text-center justify-evenly mx-auto items-center snap-x snap-mandatory max-w-7xl'>
    ...
    <motion.div 
        ...
        <div className='px-0 md:pl-10 '>
            ...
            <br/>
            <br/>
            With 3years of experience in the field, I am always looking for new and innovative ways to bring my client&apos;s visions to life.
            <br/>
            <br/>
